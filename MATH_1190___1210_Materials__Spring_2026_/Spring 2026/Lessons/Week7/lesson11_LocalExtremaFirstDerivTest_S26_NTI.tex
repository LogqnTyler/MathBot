...
\enumCN{
\item Find critical numbers of a function from given graph pf $f$ or $f^{\prime}$  or a formula for $f$. 
\item Identify increasing/decreasing intervals of a function from given graph pf $f$ or $f^{\prime}$  or a formula for $f$. 
\item Create graphs when given information about derivatives, local extrema, and critical numbers.
\item Use the First Derivative Test to classify critical numbers as Local Max/Min or Neither when given function via a graph or via a formula.   
}
...
\hand
\begin{itemize}
\item The first page of the lesson is a recap of pre-class assignment scaffolded in a slightly different way.
    \begin{itemize}
