...
\begin{itemize}
    ...
    \item Determine if a definite integral is positive, negative, or zero based on context. (\target{I1})
\end{itemize}
...
\example\ltrm{\bf\color{Fuchsia}I1} Based on the definition of definite integral, write down a mathematical expression representing the net change $\Delta w$ in the infant's weight from birth to 4 weeks for the scenario in Exercise A, and indicate its unit.
...
\item[(a)] Interpret in words the meaning of each of the following in terms of the context described above, including units.
    ...
    \item[ii.] $\ds \int_1^7 f(t)\,dt=36$\\[0.8in]
    \end{enumerate}
\end{enumerate}
\end{minipage}
