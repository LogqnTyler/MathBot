...
\def\TypeTitle{Product \& Quotient Rules\\Solutions }
...
\item$\dfrac{d}{dt}[e^t(t^2-2t+2)]=\blue{e^t(t^2-2t+2)+e^2(2t-2)}$
...
\blue{
\al{
\ds \frac{d}{dx}\left[(e^x+2)\cdot \frac{x+1}{x-1}\right]&=\frac{d}{dx}\left[ e^x+2\right]\cdot  \frac{x+1}{x-1}+(e^x+2)\cdot \frac{d}{dx} \left[ \frac{x+1}{x-1}\right]\\
&= (e^x+0)\cdot \frac{x+1}{x-1}+(e^x+2)\cdot \frac{1\cdot (x-1)-1\cdot(x+1)}{(x-1)^2}\\
&=e^x\cdot \frac{x+1}{x-1}+(e^x+2)\cdot \frac{-2}{(x-1)^2}\\
}
