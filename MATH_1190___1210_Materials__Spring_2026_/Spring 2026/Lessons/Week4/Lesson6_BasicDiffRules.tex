...
\hspace{0.5in} \fbox{$f'(a)=\displaystyle\lim_{x\to a}\frac{f(x)-f(a)}{x-a}$} \hfill\hfill \fbox{$f'(a)=\displaystyle\lim_{h\to0}\frac{f(a+h)-f(a)}{h}$} \hfill\,\\
...
\hfill\hfill\,
\\\\
\example{\color{ForestGreen}D1} / \exercise{\target{D1}} Use the graphs of $f$ and $g$ below to find the following derivatives:
\vs{-.325}\\
\mpageTth{.45}{.3}{.3}{
    \begin{tikzpicture}[]
          \begin{axis}[
