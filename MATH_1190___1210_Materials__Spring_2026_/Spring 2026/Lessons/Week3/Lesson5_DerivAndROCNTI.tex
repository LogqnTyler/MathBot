...
%\end{enumerate}\end{document} %end here for written preclass
    ...
    \ep  Write down an equation for the object you sketched in part b) and graph it in Desmos. You will want to go to \href{https://student.amplify.com/}{student.amplify.com}  and use code \desmosClassCode.    \sol{
   Equation of line will be $y=62.65(t-3)+1052.44$ or $y=62.65(t-5)+1177.74$ or $y=62.65t+864.49.$ See red dashed line on graph above.
    }
