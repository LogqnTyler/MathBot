...
\itemC{
\item Identify when the Fundamental Theorem of Calculus does and does not apply to a given problem.
\item Use the Fundamental Theorem of Calculus to evaluate a definite integral.
\item Rewrite and compute an improper integral having an infinite domain using limits.
}
}
