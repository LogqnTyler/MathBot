...
$
\hat{y}_1 = \lambda_1 t_1 = \rule{3cm}{0.4pt}
$\\
\vspace{3cm}
...
\item[(b)] Compute predictions:
        \begin{enumerate}
        \item[(i)]$\hat{y}_1 = \lambda t_1 = \rule{3cm}{0.4pt}$\\
        % {\color{blue}
        ...
        \item[(ii)]$\hat{y}_2 = \rule{3cm}{0.4pt}, 
        $\\
        \vspace{2cm}
        \end{enumerate}
...
\item[(c)] Use your observations to find an initial value for $\lambda$ and for $\alpha$ and try to get the smallest error you can using the lest number of steps possible.
\vspace{4cm}
