...
Note: You might see elsewhere that the official definition of variance is $Var(X)=\displaystyle\sum_{x\in S_X}(x-\mu)^2p(x)$. The formula boxed above is different from but equivalent to the definition.
