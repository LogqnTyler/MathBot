...
\def\TypeTitle{Limits at Infinity \\Notes To Instructor}
\def\Semester{Fall 2021} %Not Used 
\def\Course{MATH 1190 \& 1210}
\def\Targets{ {\bf\color{RoyalBlue}L2}, {\bf\color{RoyalBlue}L2} }
...
\item Some found the epidemiology example confusing. 
 ...
 \hand
 \itemI{
 \item {\bf Warmup Exercise: Exponent Properties} is intended to remind students of exponent properties that will be used later in the handout
 \item {\bf Warmup Exercise A} is intended to help students connect limits towards infinity with graphs of functions and asymptotes (or not).
...
\task  $\ds 10x^{-3}=$\unline{.5}{\blue{$\ds \frac{10}{x^3}$} }{.3}
...
\sol{
\al{
\frac{7}{\sqrt{x^3}}&=\frac{7}{(x^3)^{1/2}}\\
&=\frac{7}{x^{3/2}}\\
&=7x^{-\frac{3}{2}}
}
}
...
{\em Exponentials}}\\
\blue{
Exponential functions such as $e^x$ grow Avinash than other functions we will see. The general form is $a^x$ where $a>1$.
}
}{{\centering
{\em Power Functions }}\\
\blue{
