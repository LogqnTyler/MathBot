...
\Heading{MATH 1190 \& 1210 Survey of Calculus I}{\begin{minipage}{0.275\textwidth}\begin{center} Lesson 9:\\ Properties of Exponents \& Logarithms \\ Solutions\end{center}\end{minipage}}
...
\mpageTth{.33}{.33}{.33}{
    ...
    \begin{center}
        ...
        \draw[color=blue, ultra thick]   plot (\x,{2^(\x)})    node[right] {$f(x) = 2^x$};
        ...
        \draw[color=red, ultra thick]   plot (\x,{(1/2)^(\x)})    node[right] {$g(x) = \left(\dfrac{1}{2}\right)^x$};
...
\mpageT{.33}{.67}{
    ...
    \begin{center}
        ...
        \filldraw[blue] (8,3) circle (2.5pt);
           \addplot[domain=0.01:10, blue, ultra thick, mark=none] {ln(x)/ln(2)};
