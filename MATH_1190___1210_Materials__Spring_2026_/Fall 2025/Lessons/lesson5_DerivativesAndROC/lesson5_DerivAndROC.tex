...
%\end{enumerate}\end{document} %end here for written preclass
    ...
    \ep  Write down an equation for the object you sketched in part b) and graph it in Desmos. You will want to go to \href{https://student.desmos.com/}{student.desmos.com}  and use code \desmosClassCode.
