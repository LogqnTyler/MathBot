...
\begin{center}
    \begin{tikzpicture}[scale=.9]
          ...
          \addplot[domain=-1:3, ultra thick, blue] {-(x-2)^2};
          \addplot[domain=3:4, ultra thick, blue] {(x-4)^2-2};
          \addplot[domain=4:5, ultra thick, blue] {2*(x-4)^2-2};
          \addplot[domain=5:9, ultra thick, blue] {-2*(x-6)^2+2};
           \addplot[domain=-1:3, ultra thick, blue] {-(x-2)^2};
           \addplot[domain=5:9, ultra thick, blue] {-2*(x-6)^2+2};
        \end{axis}
    \end{tikzpicture}
...
\begin{center}
    \begin{tikzpicture}[scale=.9]
          ...
          \addplot[domain=4:5, ultra thick, blue] {2*(x-4)^2-2};
          \addplot[domain=5:9, ultra thick, blue] {-2*(x-6)^2+2};
		\addplot[domain=2:3, ultra thick, blue] {-(x-2)^2};
		\addplot[domain=3:4, ultra thick, blue] {(x-4)^2-2};
		\addplot[domain=6:9, ultra thick, blue] {-2*(x-6)^2+2};
        \end{axis}
    \end{tikzpicture}
\end{center}
}{
...
\begin{center}
    \begin{tikzpicture}[scale=.9]
		...
		\addplot[domain=3:4, ultra thick, blue] {(x-4)^2-2};
		\addplot[domain=4:5, ultra thick, blue] {2*(x-4)^2-2};
		\addplot[domain=7:9, ultra thick, blue] {-2*(x-6)^2+2};
         %
        \end{axis}
    \end{tikzpicture}
\end{center}
...
{\exercise} Let $f(x)=\dfrac{x}{x^2+1}$. We've seen that $f'(x) = \dfrac{1-x^2}{(x^2+1)^2}$, and that $f(x)$ has critical numbers $x=-1$ and $x=1$. 
\enumA{
% \item\ltrm{\color{RedOrange}A1} Find the critical numbers of $f$.

% \vfill

\item\ltrm{\color{RedOrange}A1} Find the intervals of $x$-values on which $f$ is concave up and on which $f$ is concave down.
