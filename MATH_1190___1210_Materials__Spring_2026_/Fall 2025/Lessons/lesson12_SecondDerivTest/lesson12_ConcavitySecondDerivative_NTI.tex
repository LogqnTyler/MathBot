...
\def\TypeTitle{Concavity \& The Second Derivative\\Notes To Instructor }
...
\lt  
\enum{
\item[\target{A1}:] Derivatives and Graphing
\itemC{
 \item Use the tools of calculus to:
 \itemC{
    \item Describe the meaning of concave up/down graphically and using the second derivative. 
    \item Identify concave up/down intervals and inflection points of a function from given graph or formula. 
    \item Represent concepts such as second derivative, concavity, and inflection points graphically. 
}
\item Use the graph of a function and/or its derivatives to decide whether the function is increasing, decreasing, concave up, or concave down, or to find inflection points or critical numbers.
}
\item[\target{A2}:] Local and Absolute Extrema
\itemC{
 \item      Apply the Second Derivative Test to determine the local extrema of a function graphically and algebraically. 
}
}

\lg Students will be able to...
\enumCN{
\item Interpret the second derivative in terms of concavity of a graph.
\item Use the second derivative to identify candidates for inflection points (i.e. determine when $f^{\prime\prime}=0$ or when $f^{\prime\prime}(x)$ {\em DNE}
\item Use the second derivative to identify intervals of concavity and locations of inflection points.
\item Find intervals of concavity and locations of inflection points when give graphs of $f(x)$, $f^{\prime}(x)$ and/or $f^{\prime\prime}(x)$.
\item Use the Second Derivative Test to determine if critical numbers are local max/mins.
\item Know when they {\em cannot} use the Second Derivative Test.
}

\feed
\itemC{
\item Many students thought pre-class activity was very helpful due to many examples.
\item Some students needed practice computing the second derivative. This was likely due to not realizing that $\ds f^{\prime\prime}(x)=\frac{d}{dx}[f^{\prime}(x)]$
\item Some students struggled to find inflection points due to conceptual misunderstanding (e.g. inflection points occur when $f^{\prime\prime}$ changes, sign not just when $f^{\prime\prime}=0$).
\item Some students were confused with use of sign line.
}

 \hand
 \itemI{
 \item Warmup Exercise 1 is intended to reinforce concepts from pre-class: 1) Curvature of function guarantees whether tangent lines are over/under the graph 2) Second derivative is derivative of a derivative and thus when $f^{\prime}$ is increasing, function is concave up, etc. 3) inflection points occur when {\em sign} of $f^{\prime\prime}$ changes. 
 \item Warmup Exercise 2 gives students graphs of $f$, $f^{\prime}$ and $f^{\prime\prime}$ and asks students to infer concavity and inflection points from these graphs. This is a challenging problem for most students.
 \item The Mini-lecture is a great opportunity to connect the geometry Second Derivative Test to the statement of it.
 \item Example 1 and Example A are good opportunities  to demonstrate utility of a sign line/chart when implementing Second Derivative Test as some students were confused by this in pre-class activity
 \item Exam Practice 1 is similar to Warmup Exercise 2 in that students are given graphs of $f$, $f^{\prime}$ and $f^{\prime\prime}$ and asked to identify inflection points. This is a challenging exercise. for most students and is great practice for exams.
\item Extra Practice 1 is more practice implementing Second Derivative Test.
 }

\core Warmup Exercise 2,  Example 1/Exercise A, 
...
\nti{
This is a challenging exercise for many students.  They will have seen this in the written pre-class activity. There are several good approaches to have students engage this exercise. Here are a few: a)  work in groups of 3 or 4 at tables  b)   work in small groups at the chalk/white board, c)  Have some groups do presentations, d) do a gallery walk (DJ has good ideas about how to implement this).\\\\
However you choose to engage students, you will want to help them connect the key ideas of concavity from Warmup Exercise 1 to interpretations of each graph.
}
...
\item Before $x=6$, $f^{\prime}$ is increasing and thus $f^{\prime\prime}>0$. After $x=6$,  $f^{\prime}$ is decreasing and thus $f^{\prime\prime}<0$, Since the sign of $f^{\prime\prime}$ changes, $x=6$ is an inflection point.
 ...
 \item We do not include $x=2$, $x=4$, nor $x=6$ in our concave up/down intervals since $f^{\prime\prime}(x)=0$ for each. 
}
}
}{
\sol{
\itemC{
\item {\em Concavity}
Given a graph of $f^{\prime\prime}(x)$ we look where $f^{\prime\prime}<0$ and thus graph is below the $x$-axis.  This occurs on
$(-\infty, 2),\, (2,5),\, (7,\infty)$.
...
{\bf\color{blue}Mini-lecture.}  \mod Last time, we located local extrema using the First Derivative Test. Today,  we {\em locate local extrema using the Second Derivative Test}.\\
\mpageTfour{.25}{.25}{.25}{.25}{
\nti{
I am going to annotate graph to the right and point out:
\hs{-.3}
\itemC{
...
\nti{
Some students will need prompting on how to set up a sign chart/line
}
\sol{
...
\item Interval where $g$ is concave down: $(-1\sqrt{3},1/\sqrt{3}), (1/\sqrt{3},\infty)$
...
\nti{
This is a great problem for students to get more practice dealing with a sign chart/line.
}
\sol{
...
\nti{
This question is similar to Warmup Exercise 2 and will be challenging for many students. If  you have some extra time in class, this one is well worth asking students to attempt it. If short on time, one strategy could be to choose only the graph of $f^{\prime}$ or $f^{\prime\prime}$ to engage.
}
\mpageT{.5}{.5}{
